...
const Hero3 = () => (
  <section className=" bg-[linear-gradient(to_top,rgba(0,0,0,0.5),rgba(0,0,0,0.3)),url(https://raw.githubusercontent.com/ivanexist/gcs-new/refs/heads/master/public/images/Pembangunan-Jalan/Proses-2-jalan.jpeg)] bg-cover bg-center bg-no-repeat sm:h-[40rem] lg:h-[40rem]">
    <motion.div
      ...
      <div className=" grid grid-cols-4 gap-4 mx-auto max-w-screen-xl text-white">
        ...
        <div className="sm:col-span-1 lg:col-span-2">
          <div className="flex sm:justify-center sm:items-center md:justify-end md:items-end">
            <svg
              className="h-full text-white opacity-10 transform lg:block z-10"
              viewBox="0 0 100 100"
              fill="currentColor"
