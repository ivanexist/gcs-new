    ...
    >
      ...
      >
        ...
        <div className="py-2 sm:px-4 lg:px-8 relative group">
          ...
          <h3 className="mt-8 text-xl font-bold text-blue-600 group-hover:text-white uppercase">
            {service.service_name}
          </h3>
          <p className="mt-8 text-lg text-masala-800 group-hover:text-white text-left font-roboto">
