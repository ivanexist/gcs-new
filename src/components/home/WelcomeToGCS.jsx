...
const WelcomeToGCS = () => {
  ...
  return (
    <div className="grid sm:grid-cols-1 md:grid-cols-2 my-20 bg-gray-100">
      <div className="flex flex-col justify-start items-start">
        <div className="flex justify-center items-center self-center">
          <h1 className="text-3xl font-bold uppercase m-8 pb-4 border-b-atlantis-500 border-b-2 text-blue-600">
            CORE VALUE
          </h1>
        </div>
